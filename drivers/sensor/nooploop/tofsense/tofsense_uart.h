...
#define UART_CONFIGURATION_FRAME_LENGTH   (32)
#define UART_CONFIGURATION_CHECKSUM_INDEX (0x1F)
...
struct tofsense_config_baudrate {
	uint16_t lsb;
	uint8_t msb;
...
struct tofsense_configuration_frame {
	...
	uint8_t length;      /* Fixed 0x20 => UART_CONFIGURATION_FRAME_LENGTH */
	...
	struct tofsense_config_baudrate baudrate; /* For CAN or UART */
...
_Static_assert(sizeof(struct tofsense_configuration_frame) == UART_CONFIGURATION_FRAME_LENGTH,
...
_Static_assert(sizeof(struct tofsense_uart_data_frame) == UART_DATA_FRAME_LENGTH,
...
_Static_assert(sizeof(struct tofsense_uart_query_data_frame) == UART_QUERY_FRAME_LENGTH,
